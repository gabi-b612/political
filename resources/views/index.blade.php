...
@section('content')
    <nav class="bg-blue-800 fixed w-full z-10 top-0 shadow">
        <div class="container mx-auto flex items-center justify-between px-6 py-3">
            ...
            <div>
                <a href="{{ route('admin')  }}" class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition duration-300">Nous rejoindre</a>
            </div>
        </div>
    </nav>
    ...
    <section class="bg-blue-800 text-white py-20 mt-16">
        <div class="container mx-auto flex flex-col md:flex-row items-center px-6">
            <div class="w-full md:w-1/2 text-center md:text-left mb-6 md:mb-0">
                ...
                <a href="{{ route('admin') }}" class="bg-blue-600 text-white px-6 py-3 rounded-full hover:bg-blue-700 transition duration-300">Nous rejoindre</a>
            </div>
