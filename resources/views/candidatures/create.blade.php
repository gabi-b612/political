...
@section('content')
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4">Ajouter une Candidature</h1>
        ...
        <form action="{{ route('candidatures.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nom_du_candidat" name="nom_du_candidat" value="{{ old('nom_du_candidat') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="date_de_candidature" name="date_de_candidature" value="{{ old('date_de_candidature') }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
            ...
            <div class="mb-4">
                ...
                <select id="statut" name="statut" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                    ...
                    <option value="Acceptée" {{ old('statut') == 'Acceptée' ? 'selected' : '' }}>Acceptée</option>
                    <option value="Rejetée" {{ old('statut') == 'Rejetée' ? 'selected' : '' }}>Rejetée</option>
                </select>
                @error('statut')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
